    ...
    <div className="bg-white">
      ...
      <div>
        ...
        <div className="relative mb-24 md:mb-12">
          <div
            className="absolute inset-x-0 top-0 h-1/2 bg-blue-100"
            style={{clipPath: `polygon(0 0, 100% 0, 100% 25%, 0% 100%)`}}
          />
          {authors?.length > 0 && (
            <div className="absolute bottom-0 w-full mx-auto flex justify-center z-10 transform translate-y-1/2">
              <div className="flex flex-col md:flex-row items-center gap-x-4 justify-center border border-transparent text-base font-medium rounded-md shadow-sm text-blue-700 bg-white md:divide-x px-2 divide-gray-200">
                {authors.map((author) => (
